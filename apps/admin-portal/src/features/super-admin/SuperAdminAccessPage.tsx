  ...
  return <div className="ecosystem-page super-admin-page">
    ...
    <section className="super-admin-access-grid">
      <form className="super-admin-gate" onSubmit={requestVerification}>
        ...
        <label>Security Key<input value={securityKey} onChange={(event) => setSecurityKey(event.target.value)} type="password" autoComplete="one-time-code" placeholder="Enter on a live secured session" required /></label>
        <Button label="Verify Super Admin access" type="submit" />
