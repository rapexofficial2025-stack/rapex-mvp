...
export function LoginScreen({ navigation }: Props) {
  ...
  return (
    <ScreenContainer title="Log In" subtitle="Welcome back to RAPEX">
      ...
      />
      <Button label="Don't have an account? Register" variant="secondary" onPress={() => navigation.navigate("Register")} />
    </ScreenContainer>
  );
}
