  ...
  async function routeByNextStep() {
    ...
    switch (nextStep) {
      ...
      case "WELCOME_ANIMATION":
        ...
        break;
      // UI-POLISH SCOPE CUT (temporary, this branch only): Profile/MainTabs
      // don't exist in this branch -- see RootNavigator.tsx's doc comment.
      // Restore the real targets when this merges back into
