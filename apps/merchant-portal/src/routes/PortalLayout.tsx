...
const NAV_GROUPS: NavGroup[] = [
  ...
  { key: "finance", label: "Finance & Growth", items: [{ key: "wallet", label: "Wallet", path: "/portal/wallet" }, { key: "financials", label: "Financials", stage: "Planned" }, { key: "marketing", label: "Marketing", stage: "Planned" }, { key: "analytics", label: "Analytics", stage: "Planned" }] },
