 ...
 * as notifications.ts. Without this, ErrorBoundary still catches render
 * errors and shows the recovery UI, but nothing was ever recorded
 * anywhere -- this is what actually reports it.
 */
