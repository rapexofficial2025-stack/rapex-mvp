 ...
 * Same real background asset (login-dark-2.png) and card-content layout approach
 * as customer-app's LoginScreen.tsx -- see that file's doc comment for the
 * background-vs-real-components rationale. Real Xano email/password auth
